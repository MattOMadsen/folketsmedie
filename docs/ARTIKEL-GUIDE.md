...
4. **Admin (10. sep. 2026).** Alle tre sider styres fra `/admin/`. Gem kladde. Udgiv aldrig før Matt trykker Udgiv. AI-kladder via Cursor/Grok — ikke xAI-nøgle i browseren. Se `docs/ADMIN.md`.
