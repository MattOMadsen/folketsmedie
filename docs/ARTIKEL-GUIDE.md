...
4. **Admin (10. sep. 2026).** Alle tre sider styres fra `/admin/` — artikler, politiske skandaler og Skattejægeren, delt i tre rum. Gem kladde. Udgiv aldrig før Matt trykker Udgiv. Se `docs/ADMIN.md`.
