...
- **Admin (10. sep. 2026).** Matt styrer alle tre rum fra `/admin/`, delt som sitet. Kladde uden at gå live. Udgiv kun når han trykker Udgiv. GitHub-token i browseren. **Ingen xAI-nøgle i admin.** AI-kladder kører via Cursor/Grok-build: sæt `CURSOR_API_KEY` én gang i GitHub Actions secrets. Se `docs/ADMIN.md` og `docs/AI-KLADDE.md`.
...
- **Huskefil (10. sep. 2026).** Cursor/Grok til admin sættes op *senere*, når Matt beder om det. Se `docs/HUSK.md`. Mas ikke.
