...
<p class="wp-block-paragraph">Har man en opgave derhjemme: læs <a href="https://byggepiloten.dk/guide/privat" target="_blank" rel="noopener">guiden til private</a> og opret den på <a href="https://byggepiloten.dk" target="_blank" rel="noopener">byggepiloten.dk</a>.</p>

<p class="wp-block-paragraph">Har man et firma: læs <a href="https://byggepiloten.dk/guide/firma" target="_blank" rel="noopener">guiden til firmaer</a> og tilmeld jer på <a href="https://byggepiloten.dk/opret/firma" target="_blank" rel="noopener">byggepiloten.dk/opret/firma</a>.</p>

<p class="wp-block-paragraph">Spørgsmål, der ikke står i guiden, kan sendes til <a href="mailto:admin@byggepiloten.dk">admin@byggepiloten.dk</a>.</p>
...
<p class="wp-block-paragraph">Prøv det, mens det er beta. Guiden ligger på siden. Mailen er kun til det, guiden ikke dækker.</p>
